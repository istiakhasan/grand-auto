               ...
               <input
                ...
                />
                 <label className="label">
                    ...
                    {errors.quantity?.type==='min'&& <span className="label-text-alt text-red-700 font-bold">{errors.quantity.message}</span>}
                    {errors.quantity?.type==='max'&& <span className="label-text-alt text-red-700 font-bold">{errors.quantity.message}</span>}
            ...
            <div className="form-control w-full max-w-xs mx-auto">
              <label className="label">
               ...
               <input
                ...
                />
                 <label className="label">
                    {errors.address?.type==='required'&& <span className="label-text-alt text-red-700 font-bold">{errors.address.message}</span>}
