        ...
        <Slider   {...settings}>
            <div className='ml-5 my-5'>
                ...
                <h1 className='lg:text-8xl text-5xl text-white'>Life Is Good </h1>  
                 ...
                 <p className='text-white text-md w-8/12 lg:w-4/12 my-6'>Are you looking for bike parts for your business ?You are In right place .Find your Special parts for your bike here.With thousands of products , we have just the right one for you.</p>
            ...
            <div className='ml-5 my-5'>
                ...
                <h1 className='lg:text-8xl text-5xl text-white'>Born To Ride  </h1>  
                 ...
                 <p className='text-white text-md w-8/12 lg:w-4/12 my-6'>Specificatioins and pricing are subject to change. Dealer sets the actual destination charge. your price may vary. </p>
                 <Link to="/login" className='btn btn-primary'>Click To Join</Link>
                </div>
                </div>
            </div> 
