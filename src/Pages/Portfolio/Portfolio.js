        ...
        <div className="lg:grid grid-cols-2 my-20 mx-10">
          <div>
            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700 ">
              <Timeline exam="BSC" year="2016-2020"
                institution="Computer Science and Engineering At Uttara University" />
              <Timeline exam="Web Design" year="2017" institution="CodersTrus Bangladesh" />
              <Timeline exam="HSC" year="2014-2015" institution="Govt Ashikh Mahmud Collage" />
              <Timeline exam="SSC" year="2007-2013" institution="Sharifpur High School" />
            </ol>
          </div>
          <div>
