...
const Timeline = ({year,institution,exam}) => {
    return (
        ...
        <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">{exam}</h3>
        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{year}</time>
        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">{institution}</p>
    </li>
    );
};
